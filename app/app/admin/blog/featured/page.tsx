// /admin/blog/featured — manage the up-to-3 featured slots on Switchguides
  ...
  if (!slotsResult.ok) {
    return (
      <div className="max-w-4xl space-y-4">
        <PageHeader eyebrow="Switchguides" title="Featured posts" />
  ...
  return (
    <div className="max-w-4xl space-y-6 py-6">
      <PageHeader
        ...
        subtitle="Up to 3 ranked slots on Switchguides homepage. Slot 1 = lead hero card, slots 2 + 3 = secondary cards beneath. Changing a slot fires a Netlify rebuild so the live page updates within ~2 min."
      />
