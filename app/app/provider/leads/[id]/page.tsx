  ...
  const [
    ...
    supabase
      ...
      .select(
        ...
        "age_band,employment_status,earnings_band,course_id,funding_category,funding_route,prior_level_3_or_higher,can_start_on_intake_date,preferred_intake_id,acceptable_intake_ids,start_when,start_timing,outcome_interest,la,postcode,region," +
